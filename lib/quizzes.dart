    ...
    return [
      Quiz(
        ...
        questions: [
          ...
          Question(
            ...
            answers: ['Goku', 'Saitama', 'Hirohito', 'Hashirama', 'Madara'],
            correctAnswer: 2,
          )
        ],
      ),
      Quiz(
          ...
          questions: [
            ...
            Question(
              name:
                  'Where the Dutch–Indonesian Round Table Conference was held?',
              answers: ['Jakarta', 'Tokyo', 'Amsterdam', 'Den Haag', 'London'],
              correctAnswer: 3,
            )
          ])
    ];
